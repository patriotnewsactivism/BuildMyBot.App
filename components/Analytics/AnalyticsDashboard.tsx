...
import { TrendingUp, MessageSquare, Users, DollarSign, Activity, Calendar, BarChart3, PieChart, Zap } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="text-2xl font-bold text-slate-800">${stats.totalMessages * 0.05}</div>
          <div className="text-sm text-slate-500 mt-1">Est. Savings</div>
          <div className="text-xs text-slate-400 mt-2">
            vs. human agents
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          <h3 className="font-bold text-slate-800 mb-6 flex items-center gap-2">
            <PieChart size={18} className="text-blue-900" />
            Activity Breakdown
          </h3>
          <ResponsiveContainer width="100%" height={300}>
            <RechartsPie>
