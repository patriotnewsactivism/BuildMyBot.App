...
**Current State:** Supabase migration in progress
- Auth: Supabase (active)
- Database: Supabase (active for bots, leads, profiles)
- Edge Functions: Deployed and operational (see supabase/functions/)
- Legacy: Firebase config still present (firebaseConfig.ts) - being phased out
